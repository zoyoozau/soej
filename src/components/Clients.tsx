                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 lg:gap-8">
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-xl w-full h-auto aspect-video sm:aspect-[4/3] relative flex flex-col justify-end overflow-hidden group">
                        ...
                        <div className="w-full h-full flex items-center justify-center p-4">
                            <img src="/Our Clients01.png" alt="Service Clients" className="max-w-full max-h-full object-contain mix-blend-multiply opacity-90 group-hover:scale-105 transition-transform duration-500" />
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-xl w-full h-auto aspect-video sm:aspect-[4/3] relative flex flex-col justify-end overflow-hidden group">
                        ...
                        <div className="w-full h-full flex items-center justify-center p-4">
                            <img src="/Our Clients02.png" alt="Food & Beverage Clients" className="max-w-full max-h-full object-contain mix-blend-multiply opacity-90 group-hover:scale-105 transition-transform duration-500" />
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-xl w-full h-auto aspect-video sm:aspect-[4/3] relative flex flex-col justify-end overflow-hidden group">
                        ...
                        <div className="w-full h-full flex items-center justify-center p-4 mt-8">
                            <img src="/Our Clients03.png" alt="Real Estate Clients" className="max-w-full max-h-full object-contain mix-blend-multiply opacity-90 group-hover:scale-105 transition-transform duration-500" />
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-xl w-full h-auto aspect-video sm:aspect-[4/3] relative flex flex-col justify-end overflow-hidden group">
                        ...
                        <div className="w-full h-full flex items-center justify-center p-4 mt-8">
                            <img src="/Our Clients04.png" alt="Product Clients" className="max-w-full max-h-full object-contain mix-blend-multiply opacity-90 group-hover:scale-105 transition-transform duration-500" />
                        </div>
                    </div>
                    ...
                    <div className="bg-white rounded-3xl p-6 shadow-xl w-full h-auto aspect-video sm:aspect-[4/3] md:col-span-2 lg:col-span-1 lg:col-start-2 relative flex flex-col justify-end overflow-hidden group mx-auto max-w-2xl lg:max-w-full">
                        ...
                        <div className="w-full h-full flex items-center justify-center p-4 mt-8">
                            <img src="/Our Clients05.png" alt="Clinic & Beauty Clients" className="max-w-full max-h-full object-contain mix-blend-multiply opacity-90 group-hover:scale-105 transition-transform duration-500" />
                        </div>
                    </div>
